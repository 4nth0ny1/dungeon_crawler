...
class Weapon():
    ...
    def update(self, player):
        ...
        y_dist = -(pos[1] - self.rect.centery)  # negative bc pygame y coord increase down the screen
...
class Arrow(pygame.sprite.Sprite):
    ...
    def update(self, screen_scroll, obstacle_tiles, enemy_list):
        ...
        self.rect.y += screen_scroll[0] + self.dy
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self, image, x, y, target_x, target_y):
        ...
        self.dy = -(math.sin(math.radians(self.angle)) * constants.FIREBALL_SPEED)  # pygame requires negative y coor
    ...
    def update(self, screen_scroll, player):
        ...
        # check collision with self and player
